...
--Game status
INSERT INTO CM_SysEnumItem([ITEM_ID],[TYPE_ID],ITEM_NAME,CREATE_DATE,COMMENT,[ENABLED])VALUES(1,3,N'报名',GETDATE(),N'接受报名。',1)
INSERT INTO CM_SysEnumItem([ITEM_ID],[TYPE_ID],ITEM_NAME,CREATE_DATE,COMMENT,[ENABLED])VALUES(2,3,N'关闭',GETDATE(),N'活动关闭，无法接受报名。',1)
INSERT INTO CM_SysEnumItem([ITEM_ID],[TYPE_ID],ITEM_NAME,CREATE_DATE,COMMENT,[ENABLED])VALUES(3,3,N'完成',GETDATE(),N'活动已完成。',1)
INSERT INTO CM_SysEnumItem([ITEM_ID],[TYPE_ID],ITEM_NAME,CREATE_DATE,COMMENT,[ENABLED])VALUES(4,3,N'已结算',GETDATE(),N'活动费用结算完成。',1)